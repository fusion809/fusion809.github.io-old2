...
{% include Layouts/note.md line1="While not stated in the title of this post, for the sake of brevity, this post is only about free and open-source text editors and IDEs" %}
