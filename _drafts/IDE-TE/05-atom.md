...
{% include Layouts/editor-infobox.html editor="Atom" logo="atom.png" focus="General-purpose" date="2014" developers="GitHub, Inc." license="MIT" language="CoffeeScript, CSS, JavaScript and Less." %}
### Background
