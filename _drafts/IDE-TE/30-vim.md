...
### Background
{% include Layouts/editor-infobox.html logo="gvim.png" editor="Vim" repo="vim/vim" language="C, VimL." license="<a href='https://github.com/vim/vim/blob/master/runtime/doc/uganda.txt' link='_blank'>Vim License</a>." date="November 1991." developers="Bram Moolenaar." focus="General-purpose text editor." %}
